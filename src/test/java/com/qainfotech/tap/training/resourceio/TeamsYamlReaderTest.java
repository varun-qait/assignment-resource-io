...
public class TeamsYamlReaderTest {
    ...
    @Test
    public void getListOfTeams_should_return_a_list_if_Team_object_from_db_json() throws FileNotFoundException{
    ...
    @Test
    public void Team_getActiveMembers_should_return_a_list_of_team_members_that_are_active() throws FileNotFoundException{
    ...
    @Test
    public void Team_getInactiveMembers_should_return_a_list_of_individual_team_members_that_are_inactive() throws FileNotFoundException{
